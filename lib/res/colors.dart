...
class Colours {
  static const Color app_main = Color(0xFF004EA2);
  static const Color top_app_main = Color(0xCC004EA2);
  static const Color line_red = Color(0xffE92235);
  static const Color cb_check = Color(0xff0A83C6);
