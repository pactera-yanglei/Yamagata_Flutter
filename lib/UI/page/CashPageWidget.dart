...
class CashWidget extends StatefulWidget {
  @override
  CashWidgetState createState() => new CashWidgetState();
}

class CashWidgetState extends State<CashWidget> {
  ...
  void initState() {
    ...
    _pageView = new PageView(
      ...
      children: <Widget>[
        ImagePage('images/piggy_bank_guide_image_1.png'),
        ImagePage('images/piggy_bank_guide_image_2.png'),
        ImagePage('images/piggy_bank_guide_image_3.png'),
      ],
      onPageChanged: (index) {
        setState(() {
          _currentPage = index;
  ...
  @override
  void didUpdateWidget(CashWidget oldWidget) {
