...
class CheckOutTabBarWidget extends StatefulWidget {
  //底部模式
...
class _TabBarState extends State<CheckOutTabBarWidget>
  ...
  Widget build(BuildContext context) {
    if (this._type == CheckOutTabBarWidget.TOP_TAB) {
      return new Scaffold(
        drawer: _drawer,
        appBar: new AppBar(
